...
lect_id = random.sample(range(900000, 999999), 150)

first_names = ['Gabriel', 'Isla', 'Isaac', 'Adeline', 'Julian', 'Harper', 'Elijah', 'Aurora', 'Levi', 'Hazel', 'Caleb', 'Mia', 'Jasper', 'Lily', 'Silas', 'Freya', 'Matteo', 'Adelaide', 'Xavier', 'Luna','Lucas', 'Elsie', 'Felix', 'Sadie', 'Theodore', 'Clara', 'Samuel', 'Penelope', 'Henry', 'Josephine', 'Miles', 'Florence', 'Oliver', 'Daphne', 'Leo', 'Genevieve', 'Everett', 'Maeve','Wesley','Imogen']


last_names = ["Sinclair", "Delgado", "Baxter", "Chen", "Santiago", "Stanton", "Choi", "Llewellyn", "Prescott", "Sandoval", "Lowry", "Fitzpatrick", "Maddox", "Davenport", "McPherson", "Alvarez", "Hwang", "Donovan", "Galloway", "Escobar", "McMillan", "Donovan", "Calhoun", "Park", "Cabrera", "Montoya", "Monroe", "Huffman", "Buchanan", "Gallagher", "Royce", "O'Rourke", "Sutherland", "Wiley", "Ashby", "Hendricks", "Leclerc", "Echols", "St. Clair", "Beaumont", "Hackett", "Warrington", "Windham", "Rockwell", "Callahan", "Hollingsworth", "Stetson", "Kensington", "Blakely", "Covington", "Lovelace", "Ashford", "Harrington", "Remington", "Lockwood", "Fairchild", "Townsend", "Kensington", "Ellington", "Montgomery", "Huntington"]
...
for lecturer_id in lect_id:
    ...
    lecturers.append([lecturer_id, first_name, last_name, email, password, 2])


lectureroster = os.path.join('./csvs', 'lecturers.csv')
lecturecourse = os.path.join('./csvs', 'lecturer_course.csv')

with open(lectureroster, mode='w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['lecturer_id', 'first_name', 'last_name', 'email', 'password', 'user_type'])
...
with open(lecturecourse, mode='w', newline='') as file:
    writer = csv.writer(file)
