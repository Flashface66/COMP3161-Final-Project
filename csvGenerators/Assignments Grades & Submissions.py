...
with open(allassignments, mode='w', newline='') as file:
...
studentsubmissions = os.path.join('./csvs', 'submissions.csv')
finalgrades = os.path.join('./csvs', 'grades.csv')

with open(studentsubmissions, mode='w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['assignment_id', 'student_id', 'course_id', 'file', 'due_date'])
    for records in submissions:
        writer.writerow(records)

with open(finalgrades, mode='w', newline='') as file:
    writer = csv.writer(file)
